...
parser.add_argument('--topic', default="workshop/topic", help="Topic to subscribe to, and publish messages to.")
...
if __name__ == '__main__':
    ...
    if args.message:
        ...
        while (publish_count <= args.count) or (args.count == 0):
            ...
            message['timestamp'] = datetime.datetime.now().replace(microsecond=0).isoformat()
